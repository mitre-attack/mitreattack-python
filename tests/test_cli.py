...
class TestCLI:
    ...
    def test_generate_overview_group():
        ...
        LGC_main(
            ["--domain", "mobile", "--source", "taxii", "--overview-type", "group", "--output", "test_overview_group"]
        )
    ...
    def test_generate_mapped_group():
        ...
        LGC_main(
            ["--domain", "enterprise", "--source", "taxii", "--mapped-to", "APT1", "--output", "test_mapped_group"]
        )
    ...
    def test_generate_mapped_software():
        ...
        LGC_main(
            ["--domain", "enterprise", "--source", "taxii", "--mapped-to", "S0202", "--output", "test_mapped_software"]
        )
    ...
    def test_generate_mapped_mitigation():
        ...
        LGC_main(
            ["--domain", "mobile", "--source", "taxii", "--mapped-to", "M1013", "--output", "test_mapped_mitigation"]
        )
    ...
    def test_generate_batch_group():
        ...
        LGC_main(["--domain", "ics", "--source", "taxii", "--batch-type", "group", "--output", "test_batch_group"])
    ...
    def test_generate_batch_software():
        ...
        LGC_main(
            ["--domain", "ics", "--source", "taxii", "--batch-type", "software", "--output", "test_batch_software"]
        )
