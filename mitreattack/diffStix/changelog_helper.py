...
if exists("output/detailed_output.html"):
    open("output/detailed_output.html", "w").close()
if exists("output"):
    f2 = open("output/detailed_output.html", "w")
    f2.write("<h1>Detailed ChangeLog</h1>")
else:
    os.mkdir("output")
    f2 = open("output/detailed_output.html", "w")
    f2.write("<h1>Detailed ChangeLog</h1>")
...
class DiffStix(object):
    ...
    def load_data(self):
        ...
        if output_file:
            ...
            f2.write("<h2>Select the --output_file option to get a detailed changelog between versions</h2>")
        pbar.close()
