...
def main():
    ...
    techniques_detected_by_certificate = mitre_attack_data.get_techniques_detected_by_datacomponent(datacomponent_stix_id)
    
    print(f"Techniques detected by Certificate (DS0037): Certificate Registration ({len(techniques_detected_by_certificate)}):")
